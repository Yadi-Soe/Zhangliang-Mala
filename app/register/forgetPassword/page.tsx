        ...
        <Card className="w-full bg-black border-0 rounded-none mt-20 py-20 px-10">
          ...
          <CardContent className="w-full mt-5">
            <form className="w-full flex flex-col gap-5">
              ...
              <button
                type="submit"
                className="w-full font-bold bg-[#EC6C00] px-3 py-5 mt-5 text-black text-2xl hover:bg-[#D45A00] focus:outline-none focus:ring-2 focus:ring-[#EC6C00] focus:ring-offset-2">
                Next
              </button>
            </form>
          </CardContent>
